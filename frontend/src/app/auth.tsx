...
const styles = StyleSheet.create({
  ...
  backIcon: { color: '#071B44', fontSize: 24 },
  content: { gap: Spacing.three, paddingBottom: Spacing.three, paddingTop: Spacing.one },
  brandBlock: { alignItems: 'center', gap: Spacing.one },
  logoMark: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: '#EAF5FF', borderWidth: 1, borderColor: '#BBD8FF' },
  logoIcon: { color: '#1685FF', fontSize: 22, lineHeight: 26 },
  logoText: { color: '#0B1F44', fontSize: 18, lineHeight: 24 },
  ...
  welcomeTitle: { color: '#071B44', fontSize: 36, lineHeight: 42, textAlign: 'center' },
  ...
  choiceIcon: { width: 34, color: '#071B44', textAlign: 'center', fontSize: 22 },
  googleIcon: { color: '#1A73E8' },
  choiceLabel: { flex: 1, color: '#071B44', fontSize: 17, textAlign: 'center' },
  formTitle: { maxWidth: 340, color: '#071B44', textAlign: 'center' },
  formDescription: { maxWidth: 310, textAlign: 'center', lineHeight: 22 },
  formCard: { gap: Spacing.three, borderWidth: 1, borderColor: '#DDEAF7', borderRadius: Radius.large, backgroundColor: '#FFFFFF', padding: Spacing.three, ...Shadow.soft },
  error: { color: '#DC2626', textAlign: 'center' },
  actions: { gap: Spacing.two, paddingTop: Spacing.two },
  primaryButton: { minHeight: 56, borderRadius: Radius.pill, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1685FF', ...Shadow.soft },
